---
name: sub-learn
description: Convert a subtitle file (SRT) into structured English-learning notes — a cleaned dialogue transcript + an expressions/vocab/grammar companion. Use when the user provides a subtitle path and asks for "same treatment", "study notes", or invokes /sub-learn.
argument-hint: "<srt-path> [--lang <code>] [--test <celpip|ielts|toefl|none>] [--output <dir>]"
allowed-tools: Read, Write, Edit, Glob, Grep, Bash, AskUserQuestion
created: 2026-04-12T23:10:00-04:00
updated: 2026-04-17T00:00:00-04:00
---
